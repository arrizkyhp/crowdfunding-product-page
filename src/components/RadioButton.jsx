...
const RadioButton = (props) => {
    ...
    if (props.noReward) {
      return (
        <label htmlFor="no-reward"  className={`cursor-pointer  border-2 rounded-lg border-slate-300 ${rewardSelected === "" ? 'border-2 border-blue-button-primary' : 'border-slate-300'}`}>
          <div className="py-8 px-6 pb-10 grid grid-cols-[fit-content(200px)_1fr] grid-rows-[fit-content(200px)_1fr]  gap-x-5 gap-y-3 justify-start items-start ">
  ...
  return (
    ...
    <div className="py-8 px-6 pb-5 grid grid-cols-[fit-content(200px)_1fr] grid-rows-[1fr_fit-content(200px)]  gap-x-5 gap-y-4 justify-start items-start ">
